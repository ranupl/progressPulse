            ...
            <div className="col-2 border">
                ...
                <div className="container">
                    <nav>
                        <ul>
                            <li>
                                <NavLink to="/" className="navlink"><img src="/images/dashboard.png" alt="" className="text-dark" width="15px" height="15px" />&nbsp;&nbsp;&nbsp;Dashboard</NavLink>
                            </li>
                            <li>
                                <NavLink to="/MyTimeline" className="navlink"><img src="/images/timeline.png" alt="" className="text-dark" width="23px" height="23px" />&nbsp;&nbsp;My Timeline</NavLink>
                            </li>
                            <li>
